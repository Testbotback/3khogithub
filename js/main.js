// tbh I had to look at this code for a hot minute to see what it was doing :p
...
// tests the navigator.useragent (using regex) for any phones
window.testformobile = function(useragent,callback){
...
function changecss(element, remove, add) {
